...
export class CreateConnectedAccountsTable1660000000009 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create index for account_type and account_id
        await queryRunner.createIndex('connected_accounts', new TableIndex({
            name: 'IDX_CONNECTED_ACCOUNTS_TYPE_ID',
            columnNames: ['account_type', 'account_id'],
        }));
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop indexes
        await queryRunner.dropIndex('connected_accounts', 'IDX_CONNECTED_ACCOUNTS_USER_ID');
        await queryRunner.dropIndex('connected_accounts', 'IDX_CONNECTED_ACCOUNTS_TYPE_ID');
